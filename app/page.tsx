            ...
            >
              {programs.map((prog, idx) => (
                <Link
                  href={prog.route}
                  key={prog.id}
                  className="group relative flex-shrink-0 w-[280px] md:w-[340px] snap-center rounded-2xl border border-gray-100 bg-white shadow-lg transition-transform hover:-translate-y-2 overflow-hidden"
                >
            ...
            >
              {stories.map((story, idx) => (
                <Link
                  ...
                  className="group relative flex-shrink-0 w-[260px] md:w-[320px] aspect-[3/4] snap-center overflow-hidden rounded-2xl shadow-lg transition-transform hover:-translate-y-2 cursor-pointer block"
                >
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={idx}
                  className={`group relative rounded-2xl border ${activeJourney === idx ? 'border-primary bg-white/10' : 'border-white/10 bg-white/5'} overflow-hidden transition-all duration-300 cursor-pointer`}
